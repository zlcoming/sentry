...
import {Project, Organization, Group} from 'app/types';
...
class GroupSimilarIssues extends AsyncComponent<Props, State> {
...
export default withGroupings(withOrganization(GroupSimilarIssues));
