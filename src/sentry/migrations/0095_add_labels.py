# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-08-04 19:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', sentry.db.models.fields.foreignkey.FlexibleForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sentry.Group')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='label',
            field=sentry.db.models.fields.foreignkey.FlexibleForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sentry.Label'),
        ),
    ]
